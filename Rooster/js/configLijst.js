...
// Functie om lijstconfiguratie op te halen
// Deze functie wordt nu expliciet aan het window object gekoppeld.
window.getLijstConfig = function(lijstKey) {
  ...
  console.warn(`[getLijstConfig] Configuratie voor sleutel '${lijstKey}' niet gevonden in sharepointLijstConfiguraties.`);
  return null; // Retourneer null als de key niet bestaat
};
